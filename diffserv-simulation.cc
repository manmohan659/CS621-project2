                        ...
                        FlowMonitorHelper& localFlowHelper)
{
  ...
  sourceWt3.SetAttribute("PacketSize", UintegerValue(10)); // Bytes per packet
  ...
  sourceWt2.SetAttribute("Interval",
                         TimeValue(Seconds(0.01)));        // Packet interval
  sourceWt2.SetAttribute("PacketSize", UintegerValue(10)); // Bytes per packet
  ...
  sourceWt1.SetAttribute("Interval",
                         TimeValue(Seconds(0.01)));        // Packet interval
  sourceWt1.SetAttribute("PacketSize", UintegerValue(10)); // Bytes per packet
